...
"""
some implementation of parking check (maybe stolen from somewhere by my friend)
...
def parking(domain):
    ...
    try:
        ...
        if(domain[:7]!='https://'):
            link='https://'+random_subdomain+'.'+domain+'/'
...
print(parking("mypetsite.com"))
print(parking("live.com"))
print(parking("itisravenna.edu.it"))